...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef YT_ylogger_h_INCLUDE
#define YT_ylogger_h_INCLUDE
//
//
//
//
...
typedef struct _ylogger_t {
    ...
    // the callbacks
    ylogger_func_t err_;        /**< pointer to function that does error reporting */
    ylogger_func_t wrn_;        /**< pointer to function that does warning reporting */
    ylogger_func_t info_;       /**< pointer to function that does information reporting */
    ylogger_func_t dbg_;        /**< pointer to function that does debug reporting */
...
#define YLOGGER_WRAP(__name__) ylogger_ ## __name__
#else
...
///
YLOGGER_EXPORT struct _ylogger_t *
ylogger_implicit ();
...
ylogger_enable (
        ...
        ylogger_type_t ty)
{
    ylogger->enabled_mask_ = ylogger->enabled_mask_ | ty;
}
...
ylogger_is_enabled (
        ...
        ylogger_type_t ty)
{
    return ((ylogger->enabled_mask_ & ty) == ty);
}
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Explicit
 *  Methods that explicitly provide ylogger_t
 */
///@{
...
///
    ...
    ylogger_dbg (
            ...
            const char *format,
            ...) {
        do { (void)(ylogger); (void)(format); } while (0);
    }
#endif // YT_DEBUG
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Implicit
 *  Methods that use default ylogger_t
 */
///@{
