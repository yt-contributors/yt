...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef YT_yvector_h_INCLUDE
#define YT_yvector_h_INCLUDE
//
//
//
//
...
typedef struct _yvector_t {
    ...
    // the callbacks
    yvector_func_t err_;        /**< pointer to function that does error reporting */
    yvector_func_t wrn_;        /**< pointer to function that does warning reporting */
    yvector_func_t info_;       /**< pointer to function that does information reporting */
    yvector_func_t dbg_;        /**< pointer to function that does debug reporting */
...
#define YLOGGER_WRAP(__name__) yvector_ ## __name__
#else
...
///
YLOGGER_EXPORT struct _yvector_t *
yvector_implicit ();
...
yvector_enable (
        ...
        yvector_type_t ty)
{
    yvector->enabled_mask_ = yvector->enabled_mask_ | ty;
}
...
yvector_is_enabled (
        ...
        yvector_type_t ty)
{
    return ((yvector->enabled_mask_ & ty) == ty);
}
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Explicit
 *  Methods that explicitly provide yvector_t
 */
///@{
...
///
    ...
    yvector_dbg (
            ...
            const char *format,
            ...) {
        do { (void)(yvector); (void)(format); } while (0);
    }
#endif // YT_DEBUG
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Implicit
 *  Methods that use default yvector_t
 */
///@{
