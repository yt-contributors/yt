...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef YT_yline_h_INCLUDE
#define YT_yline_h_INCLUDE
//
//
//
//
...
typedef struct _yline_t {
    ...
    // the callbacks
    yline_func_t err_;        /**< pointer to function that does error reporting */
    yline_func_t wrn_;        /**< pointer to function that does warning reporting */
    yline_func_t info_;       /**< pointer to function that does information reporting */
    yline_func_t dbg_;        /**< pointer to function that does debug reporting */
...
#define YLOGGER_WRAP(__name__) yline_ ## __name__
#else
...
///
YLOGGER_EXPORT struct _yline_t *
yline_implicit ();
...
yline_enable (
        ...
        yline_type_t ty)
{
    yline->enabled_mask_ = yline->enabled_mask_ | ty;
}
...
yline_is_enabled (
        ...
        yline_type_t ty)
{
    return ((yline->enabled_mask_ & ty) == ty);
}
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Explicit
 *  Methods that explicitly provide yline_t
 */
///@{
...
///
    ...
    yline_dbg (
            ...
            const char *format,
            ...) {
        do { (void)(yline); (void)(format); } while (0);
    }
#endif // YT_DEBUG
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Implicit
 *  Methods that use default yline_t
 */
///@{
