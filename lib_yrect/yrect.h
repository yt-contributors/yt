...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef YT_yrect_h_INCLUDE
#define YT_yrect_h_INCLUDE
//
//
//
//
...
typedef struct _yrect_t {
    ...
    // the callbacks
    yrect_func_t err_;        /**< pointer to function that does error reporting */
    yrect_func_t wrn_;        /**< pointer to function that does warning reporting */
    yrect_func_t info_;       /**< pointer to function that does information reporting */
    yrect_func_t dbg_;        /**< pointer to function that does debug reporting */
...
#define YLOGGER_WRAP(__name__) yrect_ ## __name__
#else
...
///
YLOGGER_EXPORT struct _yrect_t *
yrect_implicit ();
...
yrect_enable (
        ...
        yrect_type_t ty)
{
    yrect->enabled_mask_ = yrect->enabled_mask_ | ty;
}
...
yrect_is_enabled (
        ...
        yrect_type_t ty)
{
    return ((yrect->enabled_mask_ & ty) == ty);
}
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Explicit
 *  Methods that explicitly provide yrect_t
 */
///@{
...
///
    ...
    yrect_dbg (
            ...
            const char *format,
            ...) {
        do { (void)(yrect); (void)(format); } while (0);
    }
#endif // YT_DEBUG
...
// == == == == == == == == == == == == == == == == == == == == == ==
/** @name Implicit
 *  Methods that use default yrect_t
 */
///@{
